...
% load('rameno_odezva_a_porucha_P_akcnizasah.mat');
% rameno_odezva_a_porucha_P_akcnizasah_time2 = rameno_akcnizasah_P_2pi.time';
% rameno_odezva_a_porucha_P_akcnizasah_values2 = rameno_akcnizasah_P_2pi.signals.values';
% rameno_odezva_a_porucha_P_akcnizasah_values2 = rameno_odezva_a_porucha_P_akcnizasah_values2(1,:);
% 
% figure('name','rameno_odezva_a_porucha_leadlagmozna2_akcnizasah')
% hold on
% plot(rameno_odezva_a_porucha_P_akcnizasah_time2, rameno_odezva_a_porucha_P_akcnizasah_values2, 'color', 'red', 'Linewidth', 2);
% grid on
% axis([0, 13, -0.4, 1.14]);
% box on;
% 
...
% print -depsc /home/glab/Dropbox/4.semestr/ARI/Laboratorní_úloha/neco/Latex/Řízení/rameno_odezva_a_porucha_P_akcnizasah_-1.eps
...
%% Rameno odezva a porucha leadlagmozna
% není to leadlag, ale obecný regulátor druhého řádu navržený rltoolem
...
% rameno_odezva_a_porucha_leadlagmozna_akcnizasah_time2 = scopearray1(:,1)';
% rameno_odezva_a_porucha_leadlagmozna_akcnizasah_values2 = scopearray1(:,2)';
% 
% figure('name','rameno_odezva_a_porucha_leadlagmozna2_akcnizasah')
% hold on
% plot(rameno_odezva_a_porucha_leadlagmozna_akcnizasah_time2, rameno_odezva_a_porucha_leadlagmozna_akcnizasah_values2, 'color', 'red', 'Linewidth', 2);
% grid on
% axis([0, 13, -0.15, 0.15]);
% box on;
% 
...
% print -depsc /home/glab/Dropbox/4.semestr/ARI/Laboratorní_úloha/neco/Latex/Řízení/rameno_odezva_a_porucha_leadlagmozna_akcnizasah_-1.eps



%% Rameno odezva a porucha leadlagmozna 2pi
% není to leadlag, ale obecný regulátor druhého řádu navržený rltoolem
% load('rameno_odezva_a_porucha_leadlagmozna_2pi.mat');
% rameno_odezva_a_porucha_leadlagmozna2pi_time = scopearray(:,1)';
% rameno_odezva_a_porucha_leadlagmozna2pi_values = scopearray(:,2)';
% 
% reference = 2*pi*ones(size(rameno_odezva_a_porucha_leadlagmozna2pi_time));
% reference(1,1) = 0;
% figure('name','rameno_odezva_a_porucha_leadlagmozna');
% plot(rameno_odezva_a_porucha_leadlagmozna2pi_time, reference, 'color','green','Linewidth', 2);
% hold on
% plot(rameno_odezva_a_porucha_leadlagmozna2pi_time, rameno_odezva_a_porucha_leadlagmozna2pi_values, 'color', 'blue', 'Linewidth', 2);
% upper_bound = 2*pi * 1.2* ones(size(rameno_odezva_a_porucha_leadlagmozna2pi_time));
% plot(rameno_odezva_a_porucha_leadlagmozna2pi_time, upper_bound, '--', 'color', [0.1 0.1 0.1]);
% grid on;
% axis([0, 13, 0, 10]);
% 
% xlabel('čas [s]');
...
% legend('Referenční hodnota','Odezva ramene', 'Hranice 20% překmitu', 'Location', 'SouthEast');
% 
% print -depsc /home/glab/Dropbox/4.semestr/ARI/Laboratorní_úloha/neco/Latex/Řízení/rameno_odezva_a_porucha_leadlagmozna_2pi.eps


%% Rameno odezva a porucha leadlagmozna2_akcnizasah 2pi
% % není to leadlag, ale obecný regulátor druhého řádu navržený rltoolem
load('rameno_odezva_a_porucha_leadlagmozna_akcnizasah_2pi.mat');
rameno_odezva_a_porucha_leadlagmozna_akcnizasah2pi_time2 = scopearray1(:,1)';
rameno_odezva_a_porucha_leadlagmozna_akcnizasah2pi_values2 = scopearray1(:,2)';

figure('name','rameno_odezva_a_porucha_leadlagmozna2_akcnizasah')
hold on
plot(rameno_odezva_a_porucha_leadlagmozna_akcnizasah2pi_time2, rameno_odezva_a_porucha_leadlagmozna_akcnizasah2pi_values2, 'color', 'red', 'Linewidth', 2);
grid on
axis([0, 13, -0.15, 0.15]);
box on;
...
% print -depsc /home/glab/Dropbox/4.semestr/ARI/Laboratorní_úloha/neco/Latex/Řízení/rameno_odezva_a_porucha_leadlagmozna_akcnizasah_2pi.eps
