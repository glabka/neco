...
load('rameno_odezva_a_porucha_P.mat');
time_y = scopearray(:,1);
signal_y = scopearray(:,2);

figure('name','rameno_odezva_a_porucha_P')
hold on
...
% print -depsc /home/glab/Dropbox/4.semestr/ARI/Laboratorní_úloha/neco/Latex/Řízení/dobre_grafy/rameno_odezva_a_porucha_P.eps
%% Akcni zasah
load('rameno_odezva_a_porucha_P_akcnizasah.mat');
time_u = scopearray1(:,1);
signal_u = scopearray1(:,2);

figure('name','rameno_odezva_a_porucha_P_akcnizasah')
hold on
...
% print -depsc /home/glab/Dropbox/4.semestr/ARI/Laboratorní_úloha/neco/Latex/Řízení/dobre_grafy/rameno_odezva_a_porucha_P_akcnizasah.eps